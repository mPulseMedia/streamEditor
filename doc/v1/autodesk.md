...
TheMoment adds a new element '**ovrGen_layer**' as a child of the pre-defined element '**oo-player-container**.' All of the other elements within the overlay appear as a child of this element. (On AU's currently live site, the pre-defined player object is window["video-ooyala-player"] and the  newly added element appears as a child of 'rau-player.')
